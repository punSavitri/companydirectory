      ...
      success: function (result) {
        ...
        for (var i = 0; i < result.data.length; i++) {
          $("#output").append(
            ...
            "</td><td class='d-none  d-md-table-cell'>" +
            result.data[i].email +
            "</td><td class='d-none  d-md-table-cell'>" + result.data[i].department + "</td><td><button type='button' class='btn btn-secondary btn-sm btn_edit' id='btn_edit' data-bs-toggle='modal' data-bs-target='#update_personnel_Modal' title='edit' data-id=" +
            result.data[i].id +
